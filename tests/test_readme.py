...
class ReadmeContractTests(unittest.TestCase):
    def test_fresh_installer_auth_and_named_instance_guidance(self) -> None:
        ...
        self.assertIn("GitHub Actions\nverifies published packages", README)
        self.assertIn("does not compile private source in this release path", README)
        self.assertIn("Actions success is package evidence", README)

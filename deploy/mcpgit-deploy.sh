...
Options:
  ...
  --compose-project NAME Exact Compose project name (advanced compatibility)
...
while [[ $# -gt 0 ]]; do
  case "$1" in
    ...
    --compose-project) [[ $# -ge 2 ]] || die "--compose-project requires a value"; compose_project=$2; shift 2 ;;
